...
def test_stream_open_tag():
    ...
    assert (
        open_tag
        == b"<stream:stream id='12345' from='user@example.com' to='protocols@example.com' version='1.0' xml:lang='en' xmlns='jabber:client' xmlns:stream='http://etherx.jabber.org/streams'>"
    )
