...
import pytest
from pyjabber.network.protocols.XMLServerOutcomingParser import XMLServerOutcomingParser
...
def setup_parser():
    ...
    parser = XMLServerOutcomingParser(
        buffer, starttls, connection_manager, queue_message, host, public_host
    )
...
@patch("pyjabber.network.protocols.outgoing.XMLServerOutcomingParser.Stream")
...
@patch(
    "pyjabber.stream.protocols.outgoing.StreamServerOutcomingHandler.StreamServerOutcomingHandler.handle_open_stream"
)
