...
from pyjabber.network.server import XMLServerParser
...
class XMLServerProtocol(asyncio.Protocol):
    ...
    """
    def __init__(self, namespace, connection_manager, connection_timeout=None):
    ...
    def connection_made(self, transport):
        ...
        if transport:
            ...
            self._xml_parser.setContentHandler(
                XMLServerParser(self._transport, self.task_tls, self._connections)
            )
