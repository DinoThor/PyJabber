...
tls_queue = contextvars.ContextVar("tls_queue", default=asyncio.Queue())
connection_queue = contextvars.ContextVar("connection_queue", default=asyncio.Queue())
message_queue = contextvars.ContextVar("message_queue", default=asyncio.Queue())
